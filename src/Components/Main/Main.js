        ...
        return (
            <div className="main" ref={this.main}>
                ...
                {this.state.codeSubmitting ? (
                    <Button className="submitCode" variant="contained" color="success">
                        <CircularProgress size={'1rem'} />
                    </Button>
                ) : (
                    <Button className="submitCode" variant="contained" color="primary" onClick={this.submitCode}>
                        Run
                    </Button>
                )}
                <Button className="reset " variant="outlined" color="primary">
                    Reset
                </Button>
            </div>
        );
